      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/70 leading-relaxed">
                This project — teaching AI literacy through interactive traffic simulations and cybersecurity education — represents over 80 hours of work and impacts hundreds of students across San Diego County.
              </p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard color="cyber" hover={false} className="mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-bold mb-1">About the Founder</h2>
              <p className="font-mono text-xs text-cyan-400 mb-3">Girl Scout · STEM Student · Community Educator</p>
              <p className="text-white/70 leading-relaxed mb-3">
              ...
              <p className="text-white/70 leading-relaxed">
                My goal: every student who attends a workshop leaves understanding that AI isn't magic — it's math, data, and decisions. And that they can be the ones building it.
              </p>
            </div>
          </div>
        </GlassCard>
                ...
                <div key={i} className="flex gap-6 pl-12 relative">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-1">
                      <span className="font-mono text-xs px-2 py-0.5 rounded" style={{ color: item.color, background: item.color + "22" }}>
                        {item.date}
                      </span>
